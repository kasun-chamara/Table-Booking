...
// TableIcon replaced by MdTableRestaurant from react-icons/md
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 mb-1.5 sm:mb-2">
        <MdTableRestaurant color={isAvailable ? "#22c55e" : "#f87171"} size={18} />
...
export default function BtruemookingModal() {
  ...
  // Use theme for modal background, border, and text color
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-2 sm:p-4">
      <div
        className="rounded-2xl shadow-2xl w-full max-w-xs sm:max-w-md md:max-w-xl lg:max-w-2xl max-h-[95vh] overflow-y-auto flex flex-col"
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100 sticky top-0 bg-white z-10 rounded-t-2xl">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-green-500 flex items-center justify-center flex-shrink-0">
              <MdTableRestaurant color="#22c55e" size={24} />
            </div>
            <h2 className="text-base sm:text-xl font-semibold" style={{ color: textColor }}>Create New Booking</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center gap-2 flex-wrap">
            <span className="font-medium text-sm sm:text-base whitespace-nowrap" style={{ color: textColor }}>Allocated Table :</span>
            {selectedTables.length === 0 ? (
              <span className="text-sm italic" style={{ color: textColor, opacity: 0.6 }}>None</span>
            ) : (
        ...
        <div className="mx-3 sm:mx-4 mb-3 sm:mb-4 rounded-xl border border-gray-200 bg-gray-50 p-2 sm:p-4">
          <div className="flex justify-end mb-2 sm:mb-3">
            <span className="text-xs sm:text-sm font-semibold bg-white px-2 sm:px-3 py-1 rounded-full border border-gray-200" style={{ color: textColor }}>
        ...
        {/* Legend */}
        <div className="flex items-center gap-4 px-4 sm:px-6 pb-3 sm:pb-4 text-xs" style={{ color: textColor }}>
